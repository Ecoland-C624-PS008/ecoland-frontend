        ...
        <div className='w-full py-[10rem] px-4 bg-white'>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8'>
                <div className='w-full shadow-md border flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <button className='bg-green-500 text-white font-bold w-[200px] rounded-md font-medium my-6 mx-auto py-3 transition duration-300 ease-in-out hover:bg-green-600'>Sewa Lahan</button>
                </div>
                <div className='w-full shadow-md border flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <button className='bg-green-500 text-white font-bold w-[200px] rounded-md font-medium my-6 mx-auto py-3 transition duration-300 ease-in-out hover:bg-green-600'>Sewakan Lahan</button>
                </div>
