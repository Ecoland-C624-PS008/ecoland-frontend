  ...
  return (
    <div className='flex justify-between items-center h-20 mx-auto px-4 text-white bg-green-500'>
      ...
      <ul className='hidden md:flex'>
        ...
        <li className='font-bold text-l p-2 text-white'><Link to="/dashboard" className='border-2 border-green-700 py-2 px-6 rounded-lg bg-green-700 text-white transition duration-300 ease-in-out hover:bg-green-800 hover:border-green-800'>Dashboard</Link></li> {/* navigasi ke halaman Register */}
      </ul>
