...
const FormAddLands = () => {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      const response = await axios.post("https://ecoland-backend-api.onrender.com/upload", formData, {
        headers: {
  ...
  const saveLands = async (e) => {
    ...
    try {
      await axios.post("https://ecoland-backend-api.onrender.com/lands-admin", {
